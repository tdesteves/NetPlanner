...
In table \ref{link_transp_surv_ref_low} we can see the number of optical channels calculated using \ref{Capex_Link} and \ref{ILPOpaque_CAPEX} and the number of amplifiers for each link calculated using \ref{amplifiers}.
...
\begin{tabular}{|| c | c | c | c | c | c | c ||}
 ...
 \hline
 \multirow{9}{*}{Node Cost} & \multirow{6}{*}{Electrical} & EXCs & 6 & 10 000 \euro & 60 000 \euro & \multirow{9}{*}{400 180 \euro} \\ \cline{3-6}
 ...
 & & Line Ports & 52 & 2 500 \euro/porto & 130 000 \euro & \\ \cline{3-6}
 & & Add Ports & 34 & 2 500 \euro/porto & 85 000 \euro & \\
 \hline
 \multicolumn{6}{|| c |}{Total Network Cost} & 26 920 180 \euro \\
\hline
\end{tabular}

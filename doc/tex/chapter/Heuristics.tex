...
\input{./sdf/heuristic/opaque_survivability/heuristic_opaque_survivability}
\input{./sdf/heuristic/opaque_protection/heuristic_opaque_protection}
\input{./sdf/heuristic/transparent_survivability/heuristic_transparent_survivability}
\input{./sdf/heuristic/transparent_protection/heuristic_transparent_protection}
\input{./sdf/heuristic/translucent_survivability/heuristic_translucent_survivability}
\input{./sdf/heuristic/translucent_protection/heuristic_translucent_protection}
%Section OPEX
%Subsection with the different transport mode 
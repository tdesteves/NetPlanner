...
This first section will describe how to install Net2Plan and some of the solvers usable by it as well as the main program preferences available.
    ...
    \begin{figure}[h!]
       	\centering
       	\includegraphics[width = 13cm]{figures/Net2Plan.pdf}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width = 11cm]{figures/Net2Plan_options.pdf}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width = 7cm]{figures/Net2Plan_ipopt.pdf}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width = 7cm]{figures/Net2Plan_glpk.pdf}
...
This section will describe in some detail the tools presented in Net2Plan as a network planner, most notably how to created a traffic matrix, design a network and some of the simulation options available.
	...
	\begin{figure}[h!]
		\vspace{-0.3cm}
		\centering	
		\includegraphics[width = 16cm]{figures/Net2Plan_traffic.pdf}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width = 13cm]{figures/TrafficMatrixCreation.pdf}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width = 13cm]{figures/Net2Plan_matrix.pdf}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width = 17cm]{figures/Net2Plan_Network.pdf}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width = 12cm]{figures/Net2Plan_Network_1.pdf}
	...
	\begin{figure}[!h]
		\centering
		\begin{subfigure}[b]
			\includegraphics[width=8cm]{figures/Net2Plan_Network_parameters.pdf}
			\label{Net2Plan_Network_Parameters_a}
		\end{subfigure}

		\begin{subfigure}[b]
			\includegraphics[width=8cm]{figures/Net2Plan_Network_parameters_1.pdf}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=11cm]{figures/Net2Plan_joinMatrices.pdf}
